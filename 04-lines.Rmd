...
mil_personnel <- bind_rows(
  mil_personnel %>% select(1:6) %>% set_colnames(c("Year", "Total", "Army", "Navy", "Marine Corps", "Air Force")),
  mil_personnel %>% select(7:12) %>% set_colnames(c("Year", "Total", "Army", "Navy", "Marine Corps", "Air Force"))
)
mil_personnel
```
