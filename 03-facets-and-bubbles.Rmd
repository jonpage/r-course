...
For this session, we'll explore the Hawaii Tourism Authority (HTA) [monthly
visitor statistics](http://www.hawaiitourismauthority.org/research/research/visitor-highlights/).
I'll be working with the 
[April 2017 Table(http://www.hawaiitourismauthority.org/default/assets/File/research/monthly-visitors/Apr17%20(rev).xlsx). Feel free to download the latest available.
