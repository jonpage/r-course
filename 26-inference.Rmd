...
```{r inference-load-data, eval=FALSE}
...
```{r inference-mean-samp1, eval=FALSE}
mean(samp1)
```
...
```{r inference-hist-breaks, eval=FALSE}
...
```{r inference-loop-long, eval=FALSE}
sample_means50 <- rep(NA, 5000)
...
```{r inference-loop-again, eval=FALSE}
sample_means50 <- rep(NA, 5000)
...
```{r inference-samp-10-100, eval=FALSE}
...
```{r inference-plot-samps, eval=FALSE, tidy = FALSE}
par(mfrow = c(3, 1))
